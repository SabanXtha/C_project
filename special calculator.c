/*This is a Love calculator, for project purposes only,not to be taken seriously*/
...
int main()
{
    ...
    do {
        printf("Enter the name of person 'A': ");
        scanf("%s",&yName);

        printf("Enter the name of person 'B': ");
        scanf("%s",&pName);
        ...
        printf("The love percentage is: %.02f\n\n", perc);
